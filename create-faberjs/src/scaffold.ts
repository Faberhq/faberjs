    ...
    'package.json': JSON.stringify(
      {
        ...
        dependencies: {
          '@faber-js/core': '^1.0.4',
          '@faber-js/config': '^1.0.4',
          '@faber-js/http': '^1.0.4',
          '@faber-js/router': '^1.0.4',
          '@faber-js/orm': '^1.0.5',
          '@faber-js/queue': '^1.0.4',
          '@faber-js/events': '^1.0.4',
          '@faber-js/validation': '^1.0.4',
          '@faber-js/console': '^1.0.8',
          ...(includeAuth ? { '@faber-js/auth': '^1.0.4' } : {}),
